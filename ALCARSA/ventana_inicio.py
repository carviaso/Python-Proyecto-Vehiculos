...
from Class.bitacora import bitacora
...
class Ventana_principal:
    ...
    def __init__(self):
        ...
        # ---------------------------------------------------------------
        botton1 = Button(self.vent_p, text = "Entrar", bg = "white", command = self.new_window)
        botton1.place_configure(x = 75, y = 150, width = 100, height = 20)
        botton1

        # ---------------------------------------------------------------
        botton2 = Button(self.vent_p, text = "Salir", bg = "white", command = self.cerrar)
        botton2.place_configure(x = 225, y = 150, width = 100, height = 20)
        botton2
    ...
    def agregar_admin(self):
        ...
        botton1 = Button(self.ventana_administracion, text = "Guardar", image = self.image, command = self.guardar)
        botton1.place_configure(x = 280, y = 10, width = 50, height = 50)
        botton1
    ...
    def muestra_ingreso_usuarios(self):
        ...
        # ---------------------------------------------------------------
        botton2 = Button(self.ventana_administracion, text = "Salir", bg = "white", image = self.imagen, justify = "left", height = 60, command = self.salir)
        botton2.grid(row = 0, column = 3, columnspan = 5, ipadx = 10)
        botton2
    ...
    def agregar_cliente(self):
        ...
        Label0 = Label(self.ventana_administracion, text = "Ingresar todos los datos solicitados para\n agregar al nuevo cliente", bg = "white")
        Label0.place_configure(x = 10, y = 10, width = 260, height = 50)
        
        Label1 = Label(self.ventana_administracion, text = "Inserte numero de identificación:", bg = "white")
        Label1.place_configure(x = 10, y = 70, width = 180, height = 20)
        
        Label2 = Label(self.ventana_administracion, text = "Inserte nombre completo: ", bg = "white")
        Label2.place_configure(x = 10, y = 110, width = 180, height = 20)
        
        Label6 = Label(self.ventana_administracion, text = "Inserte la profesion: ", bg = "white")
        Label6.place_configure(x = 10, y = 150, width = 180, height = 20)
        
        Label7 = Label(self.ventana_administracion, text = "Inserte la dirreccion de casa: ", bg = "white")
        Label7.place_configure(x = 10, y = 190, width = 180, height = 20)
        
        Label8 = Label(self.ventana_administracion, text = "Lugar de trabajo: ", bg = "white")
        Label8.place_configure(x = 10, y = 230, width = 180, height = 20)


        Label3 = Label(self.ventana_administracion, text = "Inserte nombre usuario: ", bg = "white")
        Label3.place_configure(x = 10, y = 270, width = 180, height = 20)
        Label4 = Label(self.ventana_administracion, text = "Inserte la contraseña:", bg = "white")
        Label4.place_configure(x = 10, y = 310, width = 180, height = 20)
        Label5 = Label(self.ventana_administracion, text = "Confirmacion de la contraseña:", bg = "white")
        Label5.place_configure(x = 10, y = 350, width = 180, height = 20)
    ...
    def agregar_vehiculo(self):
        ...
        Label0 = Label(self.ventana_administracion, text = "Ingresar todos los datos solicitados para\n agregar el nuevo vehiculo", bg = "white")
        Label0.place_configure(x = 10, y = 10, width = 260, height = 50)
        
        Label1 = Label(self.ventana_administracion, text = "Inserte el numero de placa:", bg = "white")
        Label1.place_configure(x = 10, y = 70, width = 180, height = 20)
        
        Label2 = Label(self.ventana_administracion, text = "Inserte el modelo: ", bg = "white")
        Label2.place_configure(x = 10, y = 110, width = 180, height = 20)
        
        Label6 = Label(self.ventana_administracion, text = "Inserte la marca: ", bg = "white")
        Label6.place_configure(x = 10, y = 150, width = 180, height = 20)
        
        Label3 = Label(self.ventana_administracion, text = "Inserte el color: ", bg = "white")
        Label3.place_configure(x = 10, y = 190, width = 180, height = 20)
        
        Label4 = Label(self.ventana_administracion, text = "Inserte la cantidad de pasajeros:", bg = "white")
        Label4.place_configure(x = 10, y = 230, width = 180, height = 20)
        Label4 = Label(self.ventana_administracion, text = "Valor del alquiler por dia:", bg = "white")
        Label4.place_configure(x = 10, y = 270, width = 180, height = 20)
        ...
        botton1 = Button(self.ventana_administracion, image = self.image, text = "Guardar", command = self.guardar_vehiculo)
        botton1.place_configure(x = 280, y = 10, width = 50, height = 50)
        botton1
        # self.voll = PhotoImage(file = "C:\Michael\Desktop\Carrera\Arquitectura")
        botton2 = Button(self.ventana_administracion, image = self.imagen, text = "Salir", command = self.salir)
    ...
    def modifica_vehiculo(self):
        ...
        Label0 = Label(self.ventana_administracion,
                       ...
                       bg = "white")
        Label0.place_configure(x = 10, y = 10, width = 210, height = 50)

        Label(self.ventana_administracion, text = "Seleccione el numero de placa:", justify = "left", bg = "white")
        Label6.place_configure(x = 10, y = 70, width = 180, height = 20)
    ...
    def muestra_lista_vehiculo(self):
        ...
        lbl = Label(self.ventana_administracion, text = "Lista de vehiculos disponibles", justify = "center", width = 22, height = 4, bg = "steelblue")
        lbl.grid(row = 0, column = 0, columnspan = 5, ipadx = 290)
        
        botton2 = Button(self.ventana_administracion, image = self.imagen, text = "Salir", justify = "left", height = 60, command = self.salir)
        botton2.grid(row = 0, column = 5, ipadx = 20)
        botton2
